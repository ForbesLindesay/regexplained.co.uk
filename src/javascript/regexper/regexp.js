...
function Regexp(paper, structure) {
  var self = this;
  ...
  renderer.render_contents(paper, structure.content, function(contents) {
    var i, box;
...
Regexp.prototype = Object.create(Base.prototype);
Regexp.prototype.constructor = Regexp;

Regexp.prototype.get_connection_offset = function() {
...
Regexp.prototype.position = function(x, y) {
...
Regexp.prototype._draw_connector = function(item) {
