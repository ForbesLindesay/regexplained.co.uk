...
function Subexp(paper, structure) {
    var self = this, label;
...
Subexp.prototype = Object.create(Base.prototype);
Subexp.prototype.constructor = Subexp;

Subexp.prototype.position = function(x, y) {
...
Subexp.prototype._draw_connections = function(item) {
...
Subexp.prototype.get_connection_offset = function() {
    if (this._include_box) {
