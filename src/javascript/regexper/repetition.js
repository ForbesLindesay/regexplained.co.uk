...
function Repetition(paper, structure) {
    ...
    renderer.render(paper, structure.content, function(expression) {
        var box;
...
Repetition.prototype = Object.create(Base.prototype);
Repetition.prototype.constructor = Repetition;

Repetition.prototype.position = function(x, y) {
    var box, text_box,
...
Repetition.prototype._draw_lead_lines = function(item) {
...
Repetition.prototype._draw_skip_line = function() {
    var box = this.get_box(),
...
Repetition.prototype._draw_loop_line = function() {
    var box = this.get_box(),
        expression_box = this._expression.get_box(),
        offset = this.get_connection_offset(),
...
Repetition.prototype.get_connection_offset = function() {
