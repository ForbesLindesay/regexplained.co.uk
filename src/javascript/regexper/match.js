...
function Match(paper, structure) {
  var self = this;
...
Match.prototype = Object.create(Base.prototype);
Match.prototype.constructor = Match;

Match.prototype.position = function (x, y) {
...
Match.prototype._draw_connection = function(a, b) {
  var box_a = a.get_box(),
    box_b = b.get_box(),
...
Match.prototype.get_connection_offset = function() {
  return this._offset;
};